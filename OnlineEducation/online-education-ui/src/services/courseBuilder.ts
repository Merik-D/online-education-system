 ...
 * Provides a step-by-step construction of complex Course objects
 * with fluent interface for chaining operations
 */
...
/**
 * Module Builder - handles construction of a single module with its lessons
 */
...
/**
 * Course Builder - main builder for constructing complete courses
 * Implements the Builder pattern with fluent interface
 */
export class CourseBuilder {
  ...
  /**
   * Validates the built course structure
   */
...
/**
 * Director class - orchestrates the building process with predefined steps
 * Optional: can be used to create courses with standard templates
 */
export class CourseDirector {
  ...
  /**
   * Creates a basic course template
   */
  ...
  /**
   * Creates an advanced course template with multiple modules
   */
